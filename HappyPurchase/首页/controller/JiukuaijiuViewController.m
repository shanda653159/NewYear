...
#import "JiukuaijiuModel.h"
#import "JiukuaijiuCell.h"

@interface JiukuaijiuViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
    ...
    [LDHttpManager getRequestWithURL:self.linkUrl andParams:nil compeletionBlock:^(NSURLResponse *response, NSError *error, id obj) {
        ...
        if (error) {
            ...
            for (NSDictionary *dic in obj[@"list"]) {
                ...
                JiukuaijiuModel *model = [JiukuaijiuModel new];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JiukuaijiuCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"JiukuaijiuCell" forIndexPath:indexPath];
